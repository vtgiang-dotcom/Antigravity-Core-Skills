...
Without Admin API access (no Admin key or a Claude Enterprise organization) - and even with it, for the structural facts no usage report can show - read the request-building code:
