...
This harness transforms GitHub Copilot into a Solo-Code senior software engineer with request classification, Socratic Gate, security gates, git conventions, code quality rules, and 52 specialized skills.
...
The Copilot engine includes 52 specialized skills in `.copilot/skill/`. To invoke a skill, reference its trigger keywords. Auto-loaded skills: `code-review-expert`, `file-editor-pro`, `git-workflow-master`, `permission-guard`, `systematic-debugging`, `brainstorming`, `testing-patterns`, `api-patterns`, `solo-code-harness`.
